...
<html>
    ...
    <body>
        ...
        <form action="edit" method="post" style="text-align: center">
            ...
            <input type="text" name="notiID" value="${noti.notiID}" style="width: 500px" readonly><br>
            ...
            <input type="text" name="receiveID" value="${noti.receiveID}" style="width: 500px" required><br>
