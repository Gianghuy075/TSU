                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="col-md-3"><i class="fa fa-inr"></i> ${p1.num6}</td>
                                ...
                                <tr>
                                    ...
                                    <td class="col-md-3"><i class="fa fa-inr"></i> ${p2.num6}</td>
                                ...
                                <tr>
                                    ...
                                    <td class="col-md-3"><i class="fa fa-inr"></i> ${p3.num6}</td>
                                ...
                                <tr>
                                    ...
                                    <td class="col-md-3"><i class="fa fa-inr"></i> ${p4.num6}</td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-left text-danger"><h2><strong><i class="fa fa-inr"></i>${p1.num6+p2.num6+p3.num6+p4.num6}</strong></h2></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
