    ...
    <body>
            ...
            <nav class="navbar" style="margin: 0;padding: 10px">
                ...
                <ul class="dropdown-menu" style="background-color: #00B98E ; color: #fff; margin-left: 77%;width: 200px;">
                    <c:if test="${sessionScope.RoleID == 1}">
                        ...
                        <li style=" list-style: none;width: 300px;"><a class="text-decoration-none" href="manager_noti.jsp">Manager Screen</a></li>
        ...
        <div class="Container Bdy" style="padding-top: 9%;">
                            ...
                            <div class="Bdy-choose" style="width: 105%">
                                <div style="font-size: 20px">                       
                                    Type: <select name="typeS" id="typeS">
                                        <option value="0" ${typeSelected == "0" ? "selected" : ""}>Select here</option>
            ...
            <div class="Note-warning">                       
                <c:if test="${id == null}">
                    <h1>Please enter Type, School and Class to review data</h1>
                </c:if>
            </div>
            <c:if test="${id == 0}">                       
                <div class="Note-warning">                                
